...
class BenchmarkOptionHandler(BasicOptionHandler):
    ...
    def add_options(self, parser):
        ...
        parser.add_argument('--block_parallelization', type=int, default=-1, help='Indicate the nuber of blocks that are forwarded parallelly. <0 means forward all blocks in one pass.')
        parser.add_argument('--peak_value', type=int, required=True, help='Peak value for computing the D1 and D2 metrics.')
        ...
        parser.add_argument('--print_all_metrics', type=str2bool, nargs='?', const=True, default=False, help='Whether to print all obtained metrics as a dictionary.')
